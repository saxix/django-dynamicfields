...
init = os.path.join(ROOT, 'src', 'django_dynamicfields', '__init__.py')

app = imp.load_source('django_dynamicfields', init)
...
setup(name=app.NAME,
      ...
      url='https://github.com/saxix/django-dynamicfields',
      package_dir={'': 'src'},
